...
export default function App() {
  ...
  return (
    <div>
      <TeacherWalletBar {...teacherWallet} />
      <div style={{ display: "flex", borderBottom: "2px solid #000", padding: "16px 28px 0", flexWrap: "wrap" }}>
        ...
        {activeSession && (
          <span style={{ marginLeft: "auto", alignSelf: "center", fontSize: 11, fontFamily: "Times New Roman", background: "#000", color: "#fff", padding: "4px 12px", letterSpacing: 1 }}>
            SESSION ACTIVE: {activeSession.classId} — KEY: {activeSession.sessionKey}
          </span>
        )}
      </div>
      {page === "teacher" && <TeacherDashboard activeSession={activeSession} setActiveSession={setActiveSession} teacherWallet={teacherWallet} />}
